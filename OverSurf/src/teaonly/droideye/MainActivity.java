...
public class MainActivity extends Activity implements View.OnTouchListener,
	...
	private static CameraView cameraView_;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button flash = (Button) findViewById(R.id.button1);
		...
		initCamera();
		/*
		 * try { httpd = new HTTPD_Server(); } catch (IOException e) { // TODO
	...
	public void ShowDialogBlueTooth() {
		...
		Set<BluetoothDevice> bluetooths = webServer.btAdt.getBondedDevices();
	...
	private void initAudio() {
		...
		if (audioCapture == null) {
			audioCapture = new AudioRecord(MediaRecorder.AudioSource.MIC,
					...
					AudioFormat.ENCODING_PCM_16BIT, minTargetSize);
		}
	...
	private boolean initWebServer() {
		...
		if (webServer != null) {
			tvMessage1.setText(getString(R.string.msg_access_local)
					+ " http://" + ipAddr + ":8080");
	...
	static private native int nativeEncodingPCM(byte[] pcmdata, int length,
			byte[] mp3Data);
